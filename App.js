  ...
  import Bottomnav from './components/Bottomnav'; // Add the new Main component
          ...
          <NavigationContainer>
            <Stack.Navigator
              ...
              screenOptions={{
                ...
                // Keep the custom transition to avoid sliding animation
                transitionSpec: {
                  open: {
                    animation: 'timing',
                    config: { duration: 0 }, // No animation duration
                  },
                  close: {
                    animation: 'timing',
                    config: { duration: 0 }, // No animation duration
