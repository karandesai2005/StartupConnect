...
const Dashboard = () => {
 ...
 {
 name: 'Karan Desai',
 bio: 'The CTO and co-founder of PITCH with over 15 years of experience in tech leadership. Prowd student of Symbiosis Institute of Technology at Pune.',
 },
 {
 name: 'Jane Smith',
 ...
 const aboutContent = [
 { title: 'Our Mission', content: 'Our mission is to empower individuals and businesses...' },
 { title: 'Who We Are', content: 'We are a team of passionate developers...' },
 { title: 'Our Vision', content: 'We envision a world where every organization...' },
 { title: 'Our Values', content: 'Integrity, innovation, and customer success...' },
 { title: 'Our Team', content: '' },
 { title: 'Contact Us', content: 'Have questions or want to get in touch?...' },
 ];
 ...
 const postsUrl = `${NGROK_URL}/api/posts/myposts`;
...
const styles = StyleSheet.create({
 ...
 headerTitle: { fontSize: 22, fontWeight: '700', fontFamily: 'AvenirNextCyr' },
 tabContent: { flex: 1 },
 sectionItem: {
 flexDirection: 'row',
 alignItems: 'center',
 ...
 teamContent: { flex: 1 }, // Removed marginRight to let text span fully
 teamHeader: {
 flexDirection: 'row',
 alignItems: 'center',
 height: 50,
