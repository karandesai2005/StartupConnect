    ...
    const searchUsers = useCallback(
      debounce(async (query) => {
        ...
        try {
          ...
          console.log('Searching users at:', `${baseUrl}/api/search-users?q=${encodeURIComponent(query)}`);
          ...
          setSearchResults([]);
          Alert.alert('Error', `Failed to search users: ${error.message}. Please check your network and try again.`);
        } finally {
          setIsLoading(false);
        }
      }, 300),
